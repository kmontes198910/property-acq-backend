...
import com.kynsoft.medicaltest.application.command.labTestItemRequest.create.*;
...
@Getter
@AllArgsConstructor
public class UpdateLabTestItemRequestMessage implements ICommandMessage {
    private UUID id;
     ...
     */
    public UpdateLabTestItemRequestMessage(UUID id) {
        this.id = id;
