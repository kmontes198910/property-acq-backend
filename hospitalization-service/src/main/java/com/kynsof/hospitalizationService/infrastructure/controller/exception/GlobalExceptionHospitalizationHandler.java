...
public class GlobalExceptionHospitalizationHandler {

    @ExceptionHandler(HospitalizationNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(HospitalizationNotFoundException ex) {
