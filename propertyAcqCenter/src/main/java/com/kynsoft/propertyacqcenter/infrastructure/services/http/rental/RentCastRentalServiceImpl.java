package com.kynsoft.propertyacqcenter.infrastructure.services.http.rental;
...
@Service
public class RentCastRentalServiceImpl {
    ...
    public RentCastRentalServiceImpl(RestTemplate restTemplate) {
    ...
    public List<SaleListingResponse> getRentEstimate(String address,
        ...
        try {
            ...
            String url = BASE_URL + "/listings/rental/long-term?status=" + status;
            if (addressUrl != null) {
                url = url + "&" + addressUrl;
            }
