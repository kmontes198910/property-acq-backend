...
public interface AnalysisReadDataJPARepository extends JpaRepository<Analysis, UUID>, JpaSpecificationExecutor<Analysis> {
    @EntityGraph(attributePaths = {"property", "property.sellerName", "property.sellerContactInfo", "opportunity", "mortageDebt", "compsAtAGlance", "lastSale", "saleValue", "taxAssessments", "comparables", "statistics"})
    @Override
