...
//    private PropertyStatus propertyStatus;
    ...
    public PropertyDto toAggregateSimpleProfileByContact() {
        return PropertyDto.builder()
                .id(this.id)
                .fkId(fkId)
                .buildingArea(buildingArea)
                ...
                .hoaType(hoaType)
                .hoaFeeFrequency(hoaFeeFrequency)
                .propertyTeams(propertyTeams != null ? 
                               propertyTeams.stream()
                               .filter(team -> team.getContact() != null)
                               .map(PropertyTeam::toAggregate)
