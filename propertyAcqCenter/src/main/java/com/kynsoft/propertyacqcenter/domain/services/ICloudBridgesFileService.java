...
import com.kynsoft.propertyacqcenter.domain.dto.mailjet.SendMailjetEmailMessageDto;
...
/**
 * Interfaz para interactuar con el servicio CloudBridges para la gestión de
 * archivos
 */
public interface ICloudBridgesFileService {
    ...
    /**
     * Envía un correo electrónico a través del servicio CloudBridges utilizando
     * Mailjet
     *
     * @param emailRequest Objeto que contiene toda la información necesaria
