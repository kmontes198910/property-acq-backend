...
public class GlobalExceptionIncomeForPropertyHandler {

    @ExceptionHandler(IncomeForPropertyNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(IncomeForPropertyNotFoundException ex) {
