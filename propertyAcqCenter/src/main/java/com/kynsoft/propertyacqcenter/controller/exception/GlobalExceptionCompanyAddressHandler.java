...
public class GlobalExceptionCompanyAddressHandler {

    @ExceptionHandler(CompanyAddressNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(CompanyAddressNotFoundException ex) {
