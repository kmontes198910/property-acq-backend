...
public class GlobalExceptionPropertyDocumentHandler {

    @ExceptionHandler(PropertyDocumentNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(PropertyDocumentNotFoundException ex) {
