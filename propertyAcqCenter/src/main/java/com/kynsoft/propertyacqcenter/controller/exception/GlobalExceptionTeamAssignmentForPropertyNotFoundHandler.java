...
public class GlobalExceptionTeamAssignmentForPropertyNotFoundHandler {

    @ExceptionHandler(TeamAssignmentForPropertyNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(TeamAssignmentForPropertyNotFoundException ex) {
