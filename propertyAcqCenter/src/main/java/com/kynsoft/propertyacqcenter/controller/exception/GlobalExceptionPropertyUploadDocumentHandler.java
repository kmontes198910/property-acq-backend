...
public class GlobalExceptionPropertyUploadDocumentHandler {

    @ExceptionHandler(PropertyUploadDocumentNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(PropertyUploadDocumentNotFoundException ex) {
