...
public class GlobalExceptionExpresesForPropertyHandler {

    @ExceptionHandler(ExpresesForPropertyNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleEmergencyCaseNotFound(ExpresesForPropertyNotFoundException ex) {
