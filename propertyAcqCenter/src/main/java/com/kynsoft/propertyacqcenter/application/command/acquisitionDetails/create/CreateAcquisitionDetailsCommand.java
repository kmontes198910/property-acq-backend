...
@Getter
@Setter
public class CreateAcquisitionDetailsCommand implements ICommand {
    ...
    public static CreateAcquisitionDetailsCommand fromRequest(CreateAcquisitionDetailsRequest request) {
        return new CreateAcquisitionDetailsCommand(
    ...
    public ICommandMessage getMessage() {
        return new CreateAcquisitionDetailsMessage(id);
    }
}
