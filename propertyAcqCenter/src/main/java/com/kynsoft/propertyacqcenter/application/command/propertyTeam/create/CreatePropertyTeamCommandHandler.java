...
@Component
public class CreatePropertyTeamCommandHandler implements ICommandHandler<CreatePropertyTeamCommand> {
    ...
    public CreatePropertyTeamCommandHandler(IPropertyTeamService propertyTeamService,
    ...
    @Override
    @Transactional
    public void handle(CreatePropertyTeamCommand command) {
        ...
        this.propertyTeamService.create(PropertyTeamDto
                .builder()
                .id(command.getId())
                .contact(contact)
