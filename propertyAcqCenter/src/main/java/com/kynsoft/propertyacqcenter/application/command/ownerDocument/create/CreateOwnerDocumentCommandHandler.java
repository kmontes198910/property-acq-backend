...
@Component
public class CreateOwnerDocumentCommandHandler implements ICommandHandler<CreateOwnerDocumentCommand> {
    ...
    public CreateOwnerDocumentCommandHandler(IOwnerShipLegalEntityService ownerShipLegalEntityService, IOwnerDocumentService ownerDocumentService) {
        this.ownerShipLegalEntityService = ownerShipLegalEntityService;
        this.ownerDocumentService = ownerDocumentService;
    }

    @Override
    public void handle(CreateOwnerDocumentCommand command) {
        ...
        this.ownerDocumentService.create(ownerDoc);
    }
