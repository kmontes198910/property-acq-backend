    ...
    public void handle(UpdateAdquisitionPropertyCommand command) {
        ...
        adquisitionPropertyService.update(AdquisitionPropertyDto
                ...
                .lender(AdquisitionPropertyBuyerPropertyInformationDto
                        ...
                        .lenderServicingFee(command.getLender() != null ? command.getLender().getLenderServicingFee() : null)
                        .lenderLegalFee(command.getLender() != null ? command.getLender().getLenderLegalFee() : null)
                        .lenderAppraisalFee(command.getLender() != null ? command.getLender().getLenderAppraisalFee() : null)
                        .lenderAttorneyFees(command.getLender() != null ? command.getLender().getLenderAttorneyFees() : null)
                        .lenderLoanType(command.getLender() != null ? command.getLender().getLenderLoanType() : null)
                        .lenderLoanAmount(command.getLender() != null ? command.getLender().getLenderLoanAmount() : null)
                        .lenderInterestRate(command.getLender() != null ? command.getLender().getLenderInterestRate() : null)
                        ...
                        .lenderPayoffInstructions((command.getLender() != null && command.getLender().getLenderPayoffInstructions() != null) ? command.getLender().getLenderPayoffInstructions().getFilePath() + "|" + command.getLender().getLenderPayoffInstructions().getFileName() : null)
                        ...
                        .lenderPayoffLetter((command.getLender() != null && command.getLender().getLenderPayoffLetter() != null) ? command.getLender().getLenderPayoffLetter().getFilePath() + "|" + command.getLender().getLenderPayoffLetter().getFileName() : null)
                        .lenderPhone(command.getLender() != null ? command.getLender().getLenderPhone() : null)
                        .lenderEmail(command.getLender() != null ? command.getLender().getLenderEmail() : null)
                        .municipalLiens(command.getLender() != null ? command.getLender().getMunicipalLiens() : null)
