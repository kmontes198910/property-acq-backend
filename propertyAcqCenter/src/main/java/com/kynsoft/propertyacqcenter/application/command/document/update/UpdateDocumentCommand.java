...
@Getter
@Setter
public class UpdateDocumentCommand implements ICommand {
    ...
    public UpdateDocumentCommand(UUID id, UUID legalEntity, String fileName, String filePath, 
    ...
    public static UpdateDocumentCommand fromRequest(UpdateDocumentRequest request, UUID id) {
    ...
    public ICommandMessage getMessage() {
        return new UpdateDocumentMessage(id);
    }
}
