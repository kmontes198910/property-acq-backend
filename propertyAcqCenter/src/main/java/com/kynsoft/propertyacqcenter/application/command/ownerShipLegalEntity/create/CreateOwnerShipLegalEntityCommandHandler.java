...
@Component
public class CreateOwnerShipLegalEntityCommandHandler implements ICommandHandler<CreateOwnerShipLegalEntityCommand> {

    private final IOwnerShipLegalEntityService ownerShipLegalEntityService;
    private final ILegalEntityService legalEntityService;

    public CreateOwnerShipLegalEntityCommandHandler(IOwnerShipLegalEntityService ownerShipLegalEntityService, ILegalEntityService legalEntityService) {
        this.ownerShipLegalEntityService = ownerShipLegalEntityService;
        this.legalEntityService = legalEntityService;
    }

    @Override
    public void handle(CreateOwnerShipLegalEntityCommand command) {
        ...
        this.ownerShipLegalEntityService.create(ownerShipLegalEntityDto);
    }
