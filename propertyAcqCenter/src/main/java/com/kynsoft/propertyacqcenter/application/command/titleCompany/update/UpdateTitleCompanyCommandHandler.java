...
@Component
public class UpdateTitleCompanyCommandHandler implements ICommandHandler<UpdateTitleCompanyCommand> {
    ...
    public UpdateTitleCompanyCommandHandler(@Qualifier("titleCompanyService") ICompanyService companyService,
    ...
    @Override
    public void handle(UpdateTitleCompanyCommand command) {
