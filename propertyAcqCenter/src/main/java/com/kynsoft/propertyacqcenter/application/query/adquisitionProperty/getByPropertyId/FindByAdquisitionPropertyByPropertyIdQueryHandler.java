...
@Component
public class FindByAdquisitionPropertyByPropertyIdQueryHandler implements IQueryHandler<FindByAdquisitionPropertyByPropertyIdQuery, AdquisitionPropertyListResponse> {
    ...
    @Override
    public AdquisitionPropertyListResponse handle(FindByAdquisitionPropertyByPropertyIdQuery query) {
        return new AdquisitionPropertyListResponse(this.adquisitionPropertyService.findByPropertyId(query.getId()));
    }
}
