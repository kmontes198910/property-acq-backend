...
@Getter
@Setter
public class CreatePropertyTeamAllCommand implements ICommand {
    ...
    public CreatePropertyTeamAllCommand(UUID buyerEntityName, String property, List<UUID> buyerContactRep, List<UUID> titleEscrowCompany, 
    ...
    public static CreatePropertyTeamAllCommand fromRequest(CreatePropertyTeamAllRequest request) {
        return new CreatePropertyTeamAllCommand(
    ...
    public ICommandMessage getMessage() {
        return new CreatePropertyTeamAllMessage(id);
    }
}
