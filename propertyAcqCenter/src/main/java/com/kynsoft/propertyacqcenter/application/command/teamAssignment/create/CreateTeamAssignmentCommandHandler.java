...
public class CreateTeamAssignmentCommandHandler implements ICommandHandler<CreateTeamAssignmentCommand> {
    ...
    public CreateTeamAssignmentCommandHandler(ITeamAssignmentService teamAssignmentService, IPropertyService propertyService, ICompanyContactService companyContactService) {
