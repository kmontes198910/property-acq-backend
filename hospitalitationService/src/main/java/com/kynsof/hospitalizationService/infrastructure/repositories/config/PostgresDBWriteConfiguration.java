package com.kynsof.hospitalizationService.infrastructure.repositories.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "writeEntityManagerFactory", transactionManagerRef = "writeTransactionManager", basePackages = {
        "com.kynsof.hospitalizationService.infrastructure.repositories.command" })
public class PostgresDBWriteConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder,
        ...
        return builder.dataSource(dataSource)
                .packages("com.kynsof.hospitalizationService.infrastructure.entity")
