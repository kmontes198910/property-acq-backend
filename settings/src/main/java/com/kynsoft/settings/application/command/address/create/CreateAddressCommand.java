...
public class CreateAddressCommand implements ICommand {
    ...
    public CreateAddressCommand(AddressType addressType, String streetAddress1, String streetAddress2, String city, String state, String zipCode, String country, String nickName) {
