package com.kynsoft.settings.infrastructure.services.rabbitMq.consumer;
...
@Configuration
public class RabbitMQConsumerBusinessConfig {
    ...
    public static final String BUSINESS_QUEUE = "business.queue.settings";
