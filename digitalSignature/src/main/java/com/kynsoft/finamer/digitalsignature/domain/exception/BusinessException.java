...
public class BusinessException extends RuntimeException {
     ...
     */
    public BusinessException(DigitalSignatureErrorMessage errorMessage) {
     ...
     */
    public BusinessException(DigitalSignatureErrorMessage errorMessage, String additionalInfo) {
     ...
     */
    public BusinessException(DigitalSignatureErrorMessage errorMessage, Throwable cause) {
